                ...
                if (role >= 0 && developer.GetInteger() < 2 && gameLocal.world->spawnArgs.GetInt("rolecheck", "1") > 0)
                {
                    ...
                    if (recordEnt)
                    {
                        ...
                        else
                        {
                            ...
                            {
                            case 0:
                                rolename = common->GetLanguageDict()->GetString( "#str_02000" );
                                break;
                            case 1:
                                rolename = common->GetLanguageDict()->GetString( "#str_02001" );
                                break;
                            case 2:
                                rolename = common->GetLanguageDict()->GetString( "#str_02002" );
                                break;
                            default:
                                rolename = "???";
                                break;
...
bool idPlayer::UnstickPlayer()
{
    ...
    if (closestDistance >= 16384)
    {
        ...
        {
            common->Printf("DEBUG: failed to find unstick position.\n");
        }
        return false;
    }
    ...
    if (developer.GetInteger() >= 1)
    {
        common->Printf("DEBUG: found unstick position.\n");
    }
    return true;
}
