...
#define FLOATSIGNBITSET(f)		((*(const unsigned *)&(f)) >> 31)
#define FLOATSIGNBITNOTSET(f)	((~(*(const unsigned *)&(f))) >> 31)
#define FLOATNOTZERO(f)			((*(const unsigned *)&(f)) & ~(1<<31) )
#define INTSIGNBITSET(i)		(((const unsigned)(i)) >> 31)
#define INTSIGNBITNOTSET(i)		((~((const unsigned)(i))) >> 31)

#define	FLOAT_IS_NAN(x)			(((*(const unsigned *)&x) & 0x7f800000) == 0x7f800000)
#define FLOAT_IS_INF(x)			(((*(const unsigned *)&x) & 0x7fffffff) == 0x7f800000)
#define FLOAT_IS_IND(x)			((*(const unsigned *)&x) == 0xffc00000)
#define	FLOAT_IS_DENORMAL(x)	(((*(const unsigned *)&x) & 0x7f800000) == 0x00000000 && \
								 ((*(const unsigned *)&x) & 0x007fffff) != 0x00000000 )
